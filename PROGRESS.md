...
- Outfit 03 and clip 05 passed inspection against the beige knit/denim blouse reference. The complete native speech matches the accepted utterance; a 270-frame local edit preserves narration, adjusts timing and shows a face-free collar/button/trim detail during the longer generated clause pause. No paid replacement was needed. Two transient CLI transport failures occurred before any clip 06 credit claim or submission; native account and both model-catalog checks subsequently succeeded. Resumed safely with the original prepared identity: clip 06 is accepted for 54 credits, bringing conservative visual holds to 342. Whole-film QC and delivery remain pending.
- Clip 06 passed after local timing correction supported by matched transcripts and independently measured leading silence; 244 frames, maximum retained-anchor residual 0.050 seconds. The first three products now have reviewed footage covering the first 1,500 timeline frames (50 seconds). Outfit 04 passed comparison of the dark floral wide-leg jeans, and clip 07 is accepted under its original 54-credit quote. Conservative visual holds: 404 credits; no paid replacements. All raw generation and speech evidence remain preserved, and complete-final QC/delivery are still pending.
- Clips 07/08 passed picture and speech-evidence review after local timing correction; the first four products now cover 1,988 reviewed timeline frames. Both native/reference ASR utterances match, with recognition limitations explicitly retained; edited lengths are 257/231 frames and maximum retained-anchor residuals 0.057/0.067 seconds. Outfit 05 passed visible side-bow count and placement checks against its Shopify reference. Clip 09 is accepted for 54 credits, bringing conservative visual holds to 514 within the original 1,366-credit reservation. No replacements, additional TTS or paid analysis; final assembly/QC/delivery remain pending.
- Clips 09/10 passed sampled picture and matched-speech review. Bounded local timing preserves all original narration and exact 244/221-frame allocations; maximum residuals across all observed words are 0.084/0.092 seconds, with raw pause-boundary observations retained. The first five products now cover 2,453 reviewed timeline frames (81.77 seconds). Outfit 06 passed direct comparison of the olive/cream checks, waistband and brown-top styling against its Shopify image; the product photograph does not show the complete lower legs, which remain a footage-review limitation. No paid replacements, additional TTS or paid analysis. Whole-film QC and Drive delivery remain pending.
- Clip 11 accepted for 60 credits under its saved submission ID; conservative visual holds are now 630 within the unchanged 1,366-credit video reservation. Cleanup before this job verified zero owned listeners/processes, 71% memory-pressure free and about 200.9 GB disk free. The runner waits on the existing job and returns at its inspection checkpoint; the current-task heartbeat continues reviews. No new finished video or upload yet. The unchanged application code retains the 324-passing offline baseline.
- Clip 11 downloaded and passed its selected local edit after native/edited frame inspection. Both local ASR models flag “pairs” versus “compares/compare as” in the generated ending, so identical speech was explicitly rejected. Preserved the correct original narration and used a face-free pants-detail ending at frames 222–274; bounded timing on 28 shared-word anchors has a maximum retained residual of 0.057 seconds. The 274-frame edit and transition/detail samples were inspected, with crop/ASR limits retained. Clip 12 is running under its original 54-credit quote and saved submission ID; conservative visual holds are 684. No paid replacements or additional audio/analysis spend. Whole-film review and delivery remain pending.
- Clip 12 passed after inspection of 18 native and 18 edited frames. Paired local ASR matches all 29 normalized words; the 265-frame local timing correction retains the original speech and has maximum residual 0.076 seconds across all observed words. First six products now cover 2,992 reviewed timeline frames (99.73 seconds). A transient Canvas connection failure occurred before any look 07 credit claim or submission. Read-only account and both required model checks recovered successfully; resumed from the unchanged saved identity. No login reset, duplicate paid request or replacement was needed.
- Outfit 07 passed comparison of the cream/black polka-dot pants against its Shopify photograph; sandal framing is flagged for the moving-footage review. Clip 13 is accepted for 54 credits under its original saved identity, bringing conservative visual holds to 746 within the unchanged 1,366-credit video reservation. The preceding cleanup verified no owned processes/listeners, 71% memory-pressure free and about 200.9 GB available disk. Narration is still the original 3,170-credit batch recording; no replacements or extra API analysis. Final render/QC/delivery remain pending.
- Clip 13 passed inspection of 18 native and 17 edited picture samples. Its featured pants remain completely visible; sandals retain the tight lower margin noted at the reference gate. All 29 normalized words match between local reference/native transcriptions. The selected local timing edit has 242 frames and maximum anchor residual 0.038 seconds, preserving the original narration. Clip 14 is accepted for 54 credits under its saved submission ID; conservative visual holds are 800. No paid replacement or extra audio/analysis charge. Final assembly, whole-film QC and Drive delivery remain pending.
- Recovered clip 14 read-only under its original accepted submission after a transport interruption; no duplicate charge. Inspected native/edited samples and the ending face sequence. Base ASR confirms all 29 expected words including “print-led”; its likely hallucinated footer with five zero-duration words is retained as a recognition limitation, absent from the stronger small model. Local picture correction preserves narration and 251 frames; maximum residual across all observations is 0.056 seconds. First seven products now cover 3,485 reviewed timeline frames (116.17 seconds). Outfit 08 is accepted under its eight-credit quote; conservative visual holds are 808. Complete-final QC and delivery remain pending.
- Outfit 08 passed direct comparison of the two hip bows, dot scale, pale denim and seam/button details against its Shopify reference. The exact clip 15 audio upload then returned unknown before any video credit claim. Two official resource lookups returned not-found; the live schema explicitly defines the resource ID as an upload idempotency key reused across retries. One free upload retry with that same ID and unchanged file succeeded, and official resource lookup verified `audio / success / uploaded`. Original upload/node/submission identities are preserved; no paid generation was replayed. Continued the original clip 15 draft with the recovered audio.
- Clip 15 is accepted for 60 credits under its saved submission ID. Conservative visual holds are 868 within the original 1,366-credit video reservation; no paid replacements or extra narration/analysis. The runner waits for this same job before inspection. No new final or Drive delivery yet; application code is unchanged from the 324-passing offline run.
- Clip 15 passed inspection of 20 native full-frame samples, 10 bow-detail samples and 19 edited samples. Both hip bows and their tails, large dark dots and pale denim details remain coherent. Paired local transcription matches all 30 normalized words; the selected picture timing edit preserves original narration and 289 frames, with maximum anchor residual 0.080 seconds. Clip 16 is accepted under its original 48-credit quote and saved ID; conservative visual holds are 916. No replacement or additional audio/analysis spend. Complete-final QC and Drive delivery are still pending.
- Clip 16 passed native/edited picture inspection, including all 58 frames of an intentional bow-pants detail cutaway and adjacent cuts. Both local recognizers retain “I choose” versus “I'd choose” between the original and generated tracks; that discrepancy stays explicit. Original narration is unchanged; the 225-frame local edit uses 27 shared anchors with maximum residual 0.046 seconds and hides the mouth during the disputed contraction. First eight products now cover 3,999 reviewed frames (133.3 seconds). Outfit 09 is generating for eight credits; conservative visual holds are 924. No paid replacements or extra audio/analysis charges; full-film QC and delivery remain pending.
- Outfit 09 passed full-image and scaled torso comparison against its Shopify photograph. Matching dot scale/spacing, mock neckline, short dolman sleeves and front tuck were confirmed; the initial apparent dot-size difference was framing, not a verified garment defect. Clip 17 is accepted for 60 credits with its original saved ID; conservative visual holds are 984 within the unchanged 1,366-credit reservation. No replacement or extra TTS/analysis was needed. Full-film QC, verified delivery and completion cleanup remain pending.
- Clip 17 passed inspection of 20 native and 19 edited samples: the high-neck beige/black polka-dot dolman blouse, presenter, hands and full sneakers remain coherent. Paired small.en transcription matches all 30 normalized words (both recognize dolman as dolmen). The local 280-frame timing edit preserves original narration with maximum approximate anchor residual 0.092 seconds. Clip 18 is accepted for 54 credits under its original saved identity; conservative visual holds are 1,038. No replacement or additional TTS/analysis spend. Whole-film QC, verified Drive delivery and completion cleanup remain pending.
- Clip 18 passed inspection of native and locally timed picture samples, covering the first nine products and 4,538 frames (151.27 seconds). Paired local ASR agrees on all 30 normalized words; original narration is retained with maximum approximate timing residual 0.052 seconds. The original look 10 cropped the shoe fronts and was explicitly rejected. One freshly quoted eight-credit reference repair now shows complete shoes while retaining the mixed-print ruffle blouse and fictional identity. Clip 19 is accepted for 60 credits under its saved submission ID; conservative visual holds are 1,114 within the 1,366 reservation.
- Caption preflight found three progressive prefixes colliding on two frames after timestamp rounding (1070 and 4970). Fixed the cue builder to omit zero-frame prefixes and display the complete current phrase once. The real 554-word timeline now has 548 nonoverlapping cues; regression test reproduced the overlap before the fix. Full offline validation: **325 passed in 22.81s**, and diff whitespace checks pass. Actual rendered-frame inspection, whole-film QC and Drive delivery remain pending. No extra TTS or paid analysis.
- Clip 19 passed inspection of native full-frame/garment samples, its locally edited picture and 24 consecutive frames around two cuts. The same 30 normalized words were recognized in both audio tracks. Native silence detection verified two picture-only pause removals (one frame and twelve frames at 30 fps), followed by bounded timing correction; all observed word anchors have residual at most 0.055 seconds. Original narration and native timestamps remain preserved. Nineteen clips cover 4,810 reviewed frames (160.33 seconds). Clip 20 is accepted under its saved 60-credit submission; conservative visual holds are 1,174 including the single eight-credit image repair. Assembly, full-film QC and verified Drive delivery remain pending. Application code is unchanged from the 325-passing offline run.
- Clip 20 was recovered by downloading its existing succeeded resource after a transport failure; no generation replay. Reviewed 20 native samples, 19 edited samples and the complete 64-frame blouse-detail cutaway plus adjacent cuts. Brand pronunciation remains explicitly uncertain between local recognizers; original Jessica narration is retained while the face-free detail covers that phrase. Bounded timing uses 28 shared-word anchors after one verified silent picture cut, maximum residual 0.095 seconds. All twenty selected clips now cover exactly 5,091 reviewed timeline frames.
- Hypit final assembly is running one section at a time under saved build IDs. The first encoded section passed initial inspection of the brand reveal, product label and progressive captions; its actual 265-frame output is verified. This is partial render evidence, not whole-film signoff. The remaining sections, full encoded audio/picture/caption review, verified Drive upload and completion cleanup are still pending. Conservative Jimeng holds remain 1,174 including one eight-credit image repair; narration remains 3,170 credits, with no paid audio analysis or new music. Offline application baseline remains 325 passing tests.

### Batch haul 01 delivered (2026-09-16)

- Completed **Checks & statement denim**, ten products, 169.7 seconds, 1080×1920, exactly 5,091 frames at 30 fps. [Verified Drive final](https://drive.google.com/file/d/1iV_A7HB-tbbWs7HGGqUYSr0tT5se7SFs/view). The other fourteen selections remain queued under the active sequential-production heartbeat; this does not mark the whole batch complete.
- Slow local caption rendering was followed by a real join failure: rounded MP4 section durations altered the final frame rate and silent AAC priming shifted picture by 21 ms. Reproduced locally, extracted the actual join into a testable function, and fixed it with explicit frame-derived section durations and preserved timestamps. No paid regeneration or picture re-encoding. A regression failed before the fix; **326 offline tests pass in 27.65s** afterward.
- Inspected encoded samples across all twenty takes, ten product labels, opening/closing titles and the two former caption-collision frames. Audited all 548 rendered caption cues; visually resolved all 51 OCR disagreements as recognition errors. Every decoded final frame matches the reviewed sections in order. Full final audio ASR similarity is 98.07%; sample correlation to the exact approved Jessica/music mix is 0.999978, integrated loudness −17.07 LUFS and true peak −0.34 dBTP. Full decode passes. Evidence and honest sampled-picture/ASR limits are in `productions/haul-01/review/final-review.json`; no claim of perfect lip synchronization or real-time listening.
- Remote name, parent, **51,603,087 bytes** and MD5 `448575b8e268cf4627200df71abe3940` match the local final. SHA-256 `57c15bb9dc884d9ba6b122b1367316404a105ea1f35c6c9018705fad2be92b25`. Upload and cleanup receipts are saved; no owned processes remain and ports 5184–5188 have no listeners. Memory health is 69% free by the system pressure report; approximately 200 GB disk is available.
- Conservative usage remains **1,174 Jimeng credits** including the single eight-credit outfit repair, **3,170 ElevenLabs credits**, and **$0** additional music/analysis API spend. The second video requires its original product-specific brief and a fresh observed Jimeng balance before reservation; no second-video paid job has been submitted.

### Production speed patch and five-slot live rollout (2026-09-16)

- User authorized five concurrent Jimeng clips. Added one state writer with five remote slots, dependency-aware clip admission, polling of every active job, immediate collection, safe retries of free downloads and explicit ReviewReady agent handoffs. Ambiguous paid operations retain their original IDs and block new spending.
- Cached batch review packs provide native frame grids, product comparisons and paired local word transcripts without auto-approval. Cached preparation removes repeated setup at normal reviews. Progress and per-operation times are persisted for comparison with haul 01.
- Added native FFmpeg/libass export for the existing static haul design, keeping editable Hypit files. Native 24-fps/rounded-duration sources are normalized and trimmed to each allocation; previously fitted 30-fps files pass through. Final technical QC, actual review, Drive verification and process cleanup remain required.
- Isolated full-length replay using existing approved haul-01 footage: 36.23 seconds initially, **31.77 seconds** after final integration, including technical QC versus original caption rendering **31m14s**. No generation spend or replacement of the delivered film. Sampled typography inspected; font rasterization/shadows differ slightly from browser rendering. Evidence in haul-01/review/speed-benchmark-v2 and -v3.
- Full offline suite reached **342 passing tests** with concurrency, restart, budget, review gating, native 24-fps trimming, captions and free-download recovery coverage. Live video 02 has original 483-word/2,656-character copy, complete 169.7-second narration and 98.66% local ASR similarity. Refined quote is 1,142 + 200 repair credits. Browser balance observed 12,328 before generation.
- Configured five slots and FFmpeg; updated existing heartbeat to remove the contradictory one-job limit and resume immediately after agent reviews. First five outfit-reference operations observed running concurrently; video-clip concurrency and final delivery remain to be measured.

- Live parallel-video check: five distinct Seedance 2.0 Fast VIP operations (`clip-03` through `clip-07`) were observed **running concurrently**, submitted across 39 seconds. Read-only evidence: haul-02/review/parallel-video-observation.json. No need to infer concurrency from accepted requests alone.
- Native render validation against the delivered haul-01 film: identical decoded audio (correlation 1.0 and equal sample count); whole-sequence picture comparison above the title area has SSIM 0.983. Cached four-clip review pack returns in 0.076 seconds. Two temporary native download failures recovered using the same resource IDs; the actual `cli.download_transport_failed` code is now covered by tests.
- Prioritized explicitly approved reference repairs ahead of unrelated ready clips so corrected products do not add a final cloud-generation round. Current full offline suite: **342 passed in 26.18 seconds**.

### Five concurrent clips validated; haul 02 delivered (2026-09-16)

- Five distinct Seedance video jobs ran together; the first five were downloaded in **4m49s**. Haul 02's complete images/clips/review/edit stage took **36m50s**, compared with haul 01's 6h31m29s. This is observed end-to-end improvement across different creative work, not a controlled five-times-speed claim.
- Full 169.7-second captioned export and technical QC took **30.7s**, versus the prior twenty-section caption render's 31m14s. All 478 caption states audited; fifteen OCR differences directly inspected and resolved as recognition errors. Final encoded audio correlation to the approved Jessica/music mix: 0.999977. Sampled whole-film and per-clip pictures, all ten products and both local detail cutaways reviewed.
