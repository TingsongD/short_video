...
const states:Record<string,any>={
  ...
  Waiting:{status:'running',stage:'footage',source_analysis:{stage:'complete',state:'complete',decoded_frames:900,encoded_frames:900,total_frames:900,audio_status:'measured',processed_audio_samples:1440000,rhythm_status:'supported_candidates',event_count:48,cache_reused_chunks:4,jev_mode:'shadow',jev_status:'complete',clarifications_used:1},provider_wait:{reason:'remote_unfinished',elapsed_s:600,operation_id:'operations/offline-fixture',last_observed_at:'2026-09-22T12:00:08Z',next_poll_at:'2026-09-22T12:00:40Z'}},
