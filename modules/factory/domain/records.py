...
class Authorization(Record):
    ...
    def validate(self):
        ...
        for p in self.allowed_providers:
            if p not in PROVIDERS | {"elevenlabs", "google_tts", "google_music", "generated_music", "viral_outliers", "drive", "upload_post", "analysis", "audiovisual_analysis", "audiovisual_analysis_flashcut", "jev_decisions", "youtube_reporting", "shopify"}:
